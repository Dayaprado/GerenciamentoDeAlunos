...
public class GestaoAcademicaApp1 {
    ...
    public GestaoAcademicaApp1(Centro_Universitario centroUnitario){
    ...
    public List<String> getTodosEstudante(){
        ...
        for(Estudante estudante: estudantes){
            nomes.add(estudante.getId() + ": " + estudante.getNome());
        }
    ...
    public List<String> getAlunosMatriculados(String codDisci){
        ...
        for(Matricula matricula: matriculas){
            ...
            if(codDisci.equals(disciplina)){
                ...
                alunos.add(aluno.getId() + delimitador + aluno.getNome() + delimitador + aluno.getEmail());
            }
        }
    ...
    public List<String> getDisciplinasAluno(String codAluno){
        ...
        for(Matricula matricula: matriculas){
            ...
            if(Long.parseLong(codAluno) == id){
                ...
                disciplinas.add(disciplina.getCodigo()+ delimitador + disciplina.getCreditos());
            }
        }
    ...
    private void listaDisciplinasDoAluno(String codigoAluno){
        ...
        for(String item: disciplinas)
            System.out.println(item);
        System.out.print("Total de Crédito: " + total);
        System.out.println("");    
    }
}
